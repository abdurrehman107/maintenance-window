...
import (
	...
	"github.com/abdurrehman107/maintenance-window/internal/controller"
	webhookv1 "github.com/abdurrehman107/maintenance-window/internal/webhook/v1"
...
func init() {
	...
	utilruntime.Must(maintenanceoperatoriov1alpha1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "4cc53dd0.github.com/abdurrehman107",
