...
// +kubebuilder:webhook:path=/mutate-maintenance-custom-io-maintenence-window-io-v1-maintenancewindow,mutating=true,failurePolicy=fail,sideEffects=None,groups=maintenance.custom.io.maintenence-window.io,resources=maintenancewindows,verbs=create;update,versions=v1,name=mmaintenancewindow-v1.kb.io,admissionReviewVersions=v1
...
// +kubebuilder:webhook:path=/validate-maintenance-custom-io-maintenence-window-io-v1-maintenancewindow,mutating=false,failurePolicy=fail,sideEffects=None,groups=maintenance.custom.io.maintenence-window.io,resources=maintenancewindows,verbs=create;update,versions=v1,name=vmaintenancewindow-v1.kb.io,admissionReviewVersions=v1
